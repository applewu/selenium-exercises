...
driver.find_element_by_name('email').send_keys('hellotester')
driver.find_element_by_name('password').send_keys('xxxxxxxxxxxx')
# driver.find_element_by_id('idInput').send_keys('hellotester')
# driver.find_element_by_id('pwdInput').send_keys('xxxxxxxxxxxx')
...
driver.find_element_by_class_name('nui-editableAddr-ipt').send_keys('hellotester@163.com')
